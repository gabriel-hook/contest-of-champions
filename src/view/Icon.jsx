...
const customIcons = [
    ...
    'effect-health',
    'effect-health-steal',
    'effect-heroes-for-hire',
    'effect-idol',
    'effect-immunity-bleed',
    'effect-immunity-poison',
    'effect-incinerate',
    'effect-inseparable',
    'effect-mastermind',
    'effect-mutant-agenda',
    'effect-nullify',
    ...
    'effect-power-lock',
    'effect-regeneration',
    'effect-resist-energy',
    'effect-resist-physical',
    'effect-shock',
    'effect-stun',
    'effect-thunderbolts',
    'effect-truestrike',
    ...
    view(ctrl, { icon, spin, type, before, after }) {
        ...
        return icon && (
            <i
                m="Icon"
                style={ style }
                class={ (customIcons[ icon ] === undefined)
                    ? classNames('icon', 'fa', `fa-${ icon }`, {
                        'fa-spin': isSpinning,
                        'icon--before': before,
                        'icon--after': after,
                    })
                    : classNames('icon', 'custom-icon', `custom-icon-${ icon }`, {
                        'icon--before': before,
                        'icon--after': after,
                    }) }
            />
