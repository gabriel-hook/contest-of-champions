...
const synergies = [
    ...
    ...fromId(CHAMPION.GAMORA, [
        ...
        ...fromStars(3, 4, { toId: CHAMPION.AGENTVENOM, effectId: EFFECT.PERFECT_BLOCK }),
        ...fromStars(4, { toId: CHAMPION.SHEHULK, effectId: EFFECT.ARMOR }),
    ]),

    ...fromId(CHAMPION.GROOT, [
        ...fromStars(2, 5, { toId: CHAMPION.STARLORD, effectId: EFFECT.ARMOR }),
        ...fromStars(2, 5, { toId: CHAMPION.ROCKET, effectId: EFFECT.INSEPARABLE }),
    ...
    ...fromId(CHAMPION.PHOENIX, [
        ...
        ...fromStars(4, 5, [ CHAMPION.BEAST, CHAMPION.NIGHTCRAWLER ], { effectId: EFFECT.PERFECT_BLOCK }),
        ...fromStars(4, 5, { toId: CHAMPION.GAMORA, effectId: EFFECT.PERFECT_BLOCK }),
        ...fromStars(3, 5, [ CHAMPION.CYCLOPS90S, CHAMPION.WOLVERINE ], { effectId: EFFECT.ITS_COMPLICATED }),
    ]),
    ...
    ...fromId(CHAMPION.SPIDERMANBLACK, [
        ...fromStars(2, 4, { toId: CHAMPION.STORM, effectId: EFFECT.ARMOR }),
    ...
    ...fromId(CHAMPION.HULKBUSTER, [
        ...
        ...fromStars(4, { toId: CHAMPION.ULTRON, effectId: EFFECT.CRITICAL_RATE }),
    ]),
    ...
    ...fromId(CHAMPION.BEAST, [
        ...fromStars(4, 5, [ CHAMPION.SUPERIORIRONMAN, CHAMPION.BLACKPANTHER ], { effectId: EFFECT.COMBO }),
    ...
    ...fromId(CHAMPION.MAGNETOMARVELNOW, [
        ...
        ...fromStars(4, { toId: CHAMPION.BLACKBOLT, effectId: EFFECT.ATTACK }),
    ]),
    ...
    ...fromId(CHAMPION.KARNAK, [
        ...fromStars(3, 5, { toId: CHAMPION.BLACKBOLT, effectId: EFFECT.ARMOR }),
        ...fromStars(3, 5, { toId: CHAMPION.MAGNETO, effectId: EFFECT.CRITICAL_RATE }),
        ...fromStars(3, 5, { toId: CHAMPION.BEAST, effectId: EFFECT.PERFECT_BLOCK }),
        ...fromStars(3, 5, [ CHAMPION.CAPTAINMARVEL, CHAMPION.MSMARVEL ], { effectId: EFFECT.PERFECT_BLOCK }),
    ]),

    ...fromId(CHAMPION.MOONKNIGHT, [
        ...fromStars(2, 4, { toId: CHAMPION.SPIDERMAN, effectId: EFFECT.ARMOR }),
        ...fromStars(2, 4, [ CHAMPION.DEADPOOLXFORCE, CHAMPION.DEADPOOL ], { effectId: EFFECT.CRITICAL_DAMAGE }),
        ...fromStars(3, 4, { toId: CHAMPION.DAREDEVIL, effectId: EFFECT.PERFECT_BLOCK }),
        ...fromStars(4, { toId: CHAMPION.IRONPATRIOT, effectId: EFFECT.CRITICAL_RATE }),
    ]),
    ...
    ...fromId(CHAMPION.ABOMINATION, [
        ...
        ...fromStars(4, { toId: CHAMPION.SHEHULK, effectId: EFFECT.CRITICAL_RATE }),
        ...fromStars(4, { toId: CHAMPION.REDHULK, effectId: EFFECT.CRITICAL_RATE }),
    ]),
    ...
    ...fromId(CHAMPION.ELECTRO, [
        ...
        ...fromStars(3, 4, { toId: CHAMPION.VENOM, effectId: EFFECT.PERFECT_BLOCK }),
        ...fromStars(4, { toId: CHAMPION.SPIDERMANMORALES, effectId: EFFECT.CRITICAL_RATE }),
    ]),
    ...
    ...fromId(CHAMPION.JOEFIXIT, [
        ...
        ...fromStars(3, 4, { toId: CHAMPION.HULK, effectId: EFFECT.ATTACK }),
        ...fromStars(4, { toId: CHAMPION.MSMARVEL, effectId: EFFECT.CRITICAL_RATE }),
    ]),

    ...fromId(CHAMPION.LUKECAGE, [
        ...fromStars(2, 5, { toId: CHAMPION.IRONFIST, effectId: EFFECT.HEROES_FOR_HIRE }),
        ...fromStars(2, 5, [ CHAMPION.JUGGERNAUT, CHAMPION.IRONPATRIOT ], { effectId: EFFECT.THUNDERBOLTS }),
        ...fromStars(3, 5, { toId: CHAMPION.RHINO, effectId: EFFECT.CRITICAL_RATE }),
        ...fromStars(4, 5, { toId: CHAMPION.DAREDEVIL, effectId: EFFECT.PERFECT_BLOCK }),
    ]),
    ...
    ...fromId(CHAMPION.SHEHULK, [
        ...fromStars(3, 5, [ CHAMPION.DAREDEVIL, CHAMPION.DAREDEVILNETFLIX ], { effectId: EFFECT.STUN_ACTIVATION }),
    ...
    ...fromId(CHAMPION.SPIDERMANMORALES, [
        ...
        ...fromStars(4, { toId: CHAMPION.ELECTRO, effectId: EFFECT.CRITICAL_RATE }),
        ...fromStars(4, { toId: CHAMPION.IRONPATRIOT, effectId: EFFECT.CRITICAL_RATE }),
    ]),
    ...
    ...fromId(CHAMPION.GUILLOTINE, [
        ...
        ...fromStars(4, { toId: CHAMPION.BLACKPANTHER, effectId: EFFECT.ARMOR }),
    ]),
    ...
    ...fromId(CHAMPION.KARLMORDO, [
        ...fromStars(3, 5, { toId: CHAMPION.DRSTRANGE, effectId: EFFECT.ARMOR }),
        ...fromStars(3, 5, { toId: CHAMPION.THOR, effectId: EFFECT.CRITICAL_RATE }),
        ...fromStars(3, 5, [ CHAMPION.FALCON, CHAMPION.ABOMINATION ], { effectId: EFFECT.CRITICAL_RATE }),
        ...fromStars(3, 5, { toId: CHAMPION.DRSTRANGE, effectId: EFFECT.CRITICAL_DAMAGE }),
    ]),
    ...
    ...fromId(CHAMPION.SCARLETWITCH, [
        ...
        ...fromStars(3, 4, { toId: CHAMPION.PHOENIX, effectId: EFFECT.CRITICAL_RATE }),
    ]),
