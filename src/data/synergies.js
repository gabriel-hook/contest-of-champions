...
const synergies = [
    ...
    ...fromId(CHAMPION.GAMORA, [
        ...
        ...fromStars(3, 6, [ CHAMPION.DRAX ], EFFECT.CRITICAL_DAMAGE),
        ...fromStars(3, 6, [ CHAMPION.AGENTVENOM ], EFFECT.PERFECT_BLOCK),
        ...fromStars(4, 6, [ CHAMPION.SHEHULK ], EFFECT.ARMOR),
    ]),
    ...
    ...fromId(CHAMPION.IRONMANIW, [
        ...fromStars(3, 6, [ CHAMPION.VISION, CHAMPION.THEVISION ], EFFECT.ESOTERIC_INSIGHT),
        ...fromStars(3, 6, [ CHAMPION.IRONMAN, CHAMPION.WARMACHINE, CHAMPION.HULKBUSTER, CHAMPION.SUPERIORIRONMAN, CHAMPION.IRONPATRIOT, CHAMPION.CIVILWARRIOR ], EFFECT.AI_UPGRADE),
    ...
    ...fromId(CHAMPION.DOMINO, [
        ...fromStars(4, 6, [ CHAMPION.DEADPOOLXFORCE ], EFFECT.XFORCE),
        ...fromStars(4, 6, [ CHAMPION.DEADPOOL ], EFFECT.SIX_PACK),
        ...fromStars(4, 6, [ CHAMPION.WOLVERINEOLDMAN, CHAMPION.SABRETOOTH ], EFFECT.WEAPON_X_STRIKE_TEAM),
        ...fromStars(4, 6, [ CHAMPION.MASACRE ], EFFECT.MERCS_FOR_MONEY),
        ...fromStars(4, 6, [ CHAMPION.REDHULK ], EFFECT.CODE_RED_REVELATIONS),
        ...fromStars(4, 6, [ CHAMPION.MODOK, CHAMPION.TASKMASTER ], EFFECT.BETTER_LUCK_NEXT_TIME),
        ...fromStars(4, 6, [ CHAMPION.COLOSSUS, CHAMPION.WOLVERINE ], EFFECT.POWER_GAIN),
        ...fromStars(4, 6, [ CHAMPION.CABLE ], EFFECT.COMPLICATED),
    ]),
    ...
    ...fromId(CHAMPION.SENTRY, [
        ...
        ...fromStars(4, 6, [ CHAMPION.BLACKWIDOW, CHAMPION.VISION, CHAMPION.HAWKEYE, CHAMPION.CAPTAINAMERICA ], EFFECT.ARMOR),
        ...fromStars(4, 6, [ CHAMPION.HULK ], EFFECT.CRITICAL_DAMAGE),
    ]),
    ...
    ...fromId(CHAMPION.LOKI, [
        ...fromStars(3, 6, [ CHAMPION.THOR ], EFFECT.HEALTH),
