...
const synergies = [
    ...
    ...fromId(CHAMPION.IRONMANIW, [
        ...
        ...fromStars(4, 5, [ CHAMPION.BLACKPANTHERCW, CHAMPION.KILLMONGER ], EFFECT.WAKANDAN_INSIGHT),
    ]),
    ...
    ...fromId(CHAMPION.GOLDPOOL, [
        ...fromStars(5, [ CHAMPION.DEADPOOL, CHAMPION.VENOMPOOL, CHAMPION.GWENPOOL, CHAMPION.DEADPOOLXFORCE ], EFFECT.TEAM_DEADPOOL_AWESOME_FORCE),
        ...fromStars(5, [ CHAMPION.AGENTVENOM, CHAMPION.KARLMORDO ], EFFECT.ANNOYANCES_ASSEMBLE),
        ...fromStars(5, [ CHAMPION.CARNAGE, CHAMPION.VOID, CHAMPION.GREENGOBLIN ], EFFECT.BROKEN_MINDS),
        ...fromStars(5, [ CHAMPION.GOLDPOOL ], EFFECT.THE_GOLD_STANDARD),
    ]),
    ...
    ...fromId(CHAMPION.KILLMONGER, [
        ...
        ...fromStars(3, 5, [ CHAMPION.BLACKPANTHERCW ], EFFECT.WAKANDA_LEADERSHIP),
