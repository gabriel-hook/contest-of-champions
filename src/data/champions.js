...
const champions = [
    ...typeId(TYPE.COSMIC, [
        ...
        ...championStars({ uid: CHAMPION.GROOT }, [ 3, 4, 5 ]),
        ...championStars({ uid: CHAMPION.KAMALAKHAN }, [ 3, 4, 5 ]),
        ...championStars({ uid: CHAMPION.MSMARVEL }, [ 3, 4 ]),
        ...championStars({ uid: CHAMPION.PHOENIX }, [ 5 ]),
        ...championStars({ uid: CHAMPION.PHOENIXDARK }, [ 5 ]),
        ...championStars({ uid: CHAMPION.RONAN }, [ 2, 3, 4, 5 ]),
        ...championStars({ uid: CHAMPION.SPIDERMANBLACK }, [ 3, 4 ]),
        ...championStars({ uid: CHAMPION.SUPERIORIRONMAN }, [ 2, 3, 4 ]),
    ...
    ...typeId(TYPE.TECH, [
        ...
        ...championStars({ uid: CHAMPION.HULKBUSTER }, [ 2, 3, 4 ]),
    ...
    ...typeId(TYPE.MUTANT, [
        ...
        ...championStars({ uid: CHAMPION.COLOSSUS }, [ 1, 2, 3, 4 ]),
        ...
        ...championStars({ uid: CHAMPION.X23 }, [ 3, 4 ]),
    ]),
    ...typeId(TYPE.SKILL, [
        ...
        ...championStars({ uid: CHAMPION.MOONKNIGHT }, [ 3, 4 ]),
        ...championStars({ uid: CHAMPION.PUNISHER }, [ 2, 3, 4 ]),
        ...championStars({ uid: CHAMPION.REDSKULL }, [ 3, 4, 5 ]),
    ...
    ...typeId(TYPE.SCIENCE, [
        ...
        ...championStars({ uid: CHAMPION.QUAKE }, [ 3, 4, 5 ]),
        ...
        ...championStars({ uid: CHAMPION.YELLOWJACKET }, [ 2, 3, 4 ]),
    ]),
    ...typeId(TYPE.MYSTIC, [
        ...championStars({ uid: CHAMPION.DRSTRANGE }, [ 3, 4 ]),
        ...championStars({ uid: CHAMPION.DRSTRANGEMARVELNOW }, [ 3, 4, 5 ]),
        ...championStars({ uid: CHAMPION.GUILLOTINE }, [ 2, 3, 4 ]),
