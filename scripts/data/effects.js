...
CoC.data.effects = new Backbone.Collection([
  ...
  { uid: "powergain", name:"Power Gain", description:"Gain additional Power (used to trigger a special) whenever Power is gained.", image:"images/effects/mana.jpg", base:3 },
  { uid: "powersteal", name:"Power Steal", description:"Gain Power (used to trigger a special) when attacking.", image:"images/effects/mana_steal.jpg", base:3 },
